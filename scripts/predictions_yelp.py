...
df = pd.read_csv("../data/balanced_yelp_dataset.csv") #change to relevant filepath
...
# Export results
df.to_csv("../data/predictions/yelp_predictions.csv", index=False) #change to relevant filepath