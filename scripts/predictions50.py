...
df = pd.read_csv("../data/test_5050.csv")
label_encoder = LabelEncoder()
df["label"] = label_encoder.fit_transform(df["label"])


model = BertForSequenceClassification.from_pretrained("./models/imdb_bert_50")
tokenizer = BertTokenizer.from_pretrained("./models/imdb_bert_50")
model.eval()
...
# Export results
df.to_csv("../data/predictions/bert_50_orig_predictions.csv", index=False)