...
df = pd.read_csv("../data/invariance_swapped_data.csv") #change to relevant filepath
...
# Export results
df.to_csv("../data/predictions/invariance_predictions.csv", index=False) #change to relevant filepath