...
model = BertForSequenceClassification.from_pretrained("./models/imdb_bert_90")
tokenizer = BertTokenizer.from_pretrained("./models/imdb_bert_90")
model.eval()
...
# Export results
df.to_csv("../data/predictions/bert_90_orig_predictions.csv", index=False)