...
# Load pre-split data
train_df = pd.read_csv("../data/train_1090.csv")  # or train_5050.csv etc.
test_df = pd.read_csv("../data/test_1090.csv")
...
model.save_pretrained("./models/imdb_bert_10")
tokenizer.save_pretrained("./models/imdb_bert_10")